	...
	$(document).ready(function() {
		...
		$("#order_customer_pending").on("click", "td button", function(e) {
			...
			if(value == 'Cập nhật'){
				...
				var ans = confirm("Bạn có chắc chắn muốn hủy đơn hàng?");
				if (ans == true) {
...
<div class="container">
	...
	<div class="alert alert-success" id="flash-product-ordered" hidden>
	    <strong>Thêm đơn hàng thành công</strong>
	</div>
	<div class="alert alert-success" id="flash-order-cancel" hidden>
	    <strong>Hủy đơn hàng thành công!</strong>
	</div>
	<div class="alert alert-success" id="flash-order-update" hidden>
	    <strong>Cập nhật đơn hàng thành công!</strong>
	</div>
	    ...
	    <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <p>Thay đổi số lượng sản phẩm</p>
		        <form>
		      ...
		      <div class="modal-footer">
		      	<button type="button" id="order_update_confirm" class="btn btn-success" data-dismiss="modal">Cập nhật</button>
	...
	<div style="text-align: center"><h3>Đơn hàng đang chờ xử lý</h3></div>
