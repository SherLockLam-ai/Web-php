...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<button class="order_admin_processing_update btn btn-info">Cập nhật</button>
					<button class="order_admin_processing_cancel btn btn-warning" style="display: none;">Cancel</button>';
