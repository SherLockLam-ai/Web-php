...
<div class="container">
	    ...
	    <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		      	<button type="button" id="product_order_confirm" class="btn btn-success" data-dismiss="modal">Xác nhận</button>
	...
	<div style="text-align: center"><h3>Sản phẩm có sẵn trong kho</h3></div>
