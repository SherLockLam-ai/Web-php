...
<script>
	$(document).ready(function() {
		var dataTable = $('#order_admin_cancelled').DataTable( {
			"processing": true,
			"serverSide": true,
			"ajax":{
				url :"data_order_admin_cancelled.php", // json datasource
				type: "POST",  // method  , by default get
				
				error: function(){  // error handling
					$(".order_admin_cancelled-error").html("");
					$("#order_admin_cancelled").append('<tbody class="order_admin_cancelled-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
					$("#order_admin_cancelled_processing").css("display","none");
		...
		$("#order_admin_cancelled_filter").css("display","none");  // hiding global search box
...
<div class="container">
	...
	<table id="order_admin_cancelled" class="table table-striped table-bordered">
		<thead>
			<tr>
				<th>Id</th>
				<th>Tên sản phẩm</th>
