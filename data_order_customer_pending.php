...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<button class="order_customer_pending_update btn btn-info">Cập nhật</button>
					<button class="order_customer_pending_cancel btn btn-warning">Hủy</button>';
