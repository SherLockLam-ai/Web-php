...
<div class="container">
	...
	<div class="alert alert-danger" id="flash-error" hidden>
		<strong>Thử lại với giá trị hợp lệ!</strong>
	</div>
	...
	<div class="alert alert-success" id="flash-success-updated" hidden>
	    <strong>Cập nhật thông tin sản phẩm thành công!</strong>
	</div>
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	      	<button type="button" id="add_product" class="btn btn-success" data-dismiss="modal">Thêm</button>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <form>
			    ...
			    <div class="form-group">
			    	<label>Trạng thái còn hàng</label>
	      ...
	      <div class="modal-footer">
	      	<button type="button" id="edit_product" class="btn btn-success" data-dismiss="modal">Lưu thay đổi</button>
	        <button type="button" class="btn btn-danger" data-dismiss="modal">Hủy</button>
	      </div>
	    </div>
	...
	<div style="text-align: center"><h3>Kho hàng</h3> </div>
	<div align="right">
		<button id="add_product" class="btn btn-info" data-toggle="modal" data-target="#modal_product_add">Thêm sản phẩm</button>
	</div>
